...
import com.liuli.boot.sharding.entity.ProductDescript;
...
public interface ProductDao {
    ...
    @Select("select i.price, i.product_info_id productInfoId, i.product_name productName, i.store_info_id storeInfoId, i.region_code regionCode,d.descript,r.region_name placeOfOrigin from product_info i join product_descript d on i.product_info_id = d.product_info_id " +
            " join region r on i.region_code = r.region_code order by i.product_info_id desc limit #{start},#{pageSize}")
